...
import { workExperienceSchema, WorkExperiencesValues } from "@/lib/schema";
...
function WorkExperiencesForm({ resumeData, setResumeData }: EditorFormProps) {
...
function WorkExperienceItem({
  ...
  return (
    ...
    >
      ...
      <FormDescription>
        Leave <span className="font-semibold">End date</span> empty of you are
